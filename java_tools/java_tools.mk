...
PERF_TRACE_ENUM_JAR = $(JAVA_TOOLS)/perf_trace_enum_generator/build/libs/PerfTraceEnumGenerator.jar
...
$(PERF_TRACE_ENUM_JAR): .FORCE
	cd $(GRADLE_ROOT) && $(FLOCK) ./gradlew :perf_trace_enum_generator:shadowJar
