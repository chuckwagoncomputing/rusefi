...
$(TCDEP): $(DEPDIR)/%.o.d: %.c $(TGT_SENTINEL) | $(CONFIG_FILES) $(DOCS_ENUMS) $(DEPDIR)
	@echo Gen deps for $(<F)
	@$(CC) -M -MP -MF $@ $(CFLAGS) -I. $(IINCDIR) $<

$(TCPPDEP): $(DEPDIR)/%.o.d: %.cpp $(TGT_SENTINEL) | $(CONFIG_FILES) $(DOCS_ENUMS) $(DEPDIR)
	@echo Gen deps for $(<F)
	@$(CPPC) -M -MP -MF $@ $(CPPFLAGS) -I. $(IINCDIR) $<

$(TCCDEP): $(DEPDIR)/%.o.d: %.cc $(TGT_SENTINEL) | $(CONFIG_FILES) $(DOCS_ENUMS) $(DEPDIR)
	@echo Gen deps for $(<F)
	@$(CPPC) -M -MP -MF $@ $(CPPFLAGS) -I. $(IINCDIR) $<
