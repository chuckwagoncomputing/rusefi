...
DOCS_ENUMS_INPUTS = \
  ...
  $(PROJECT_DIR)/$(META_OUTPUT_ROOT_FOLDER)controllers/algo/generated_trigger_type_e.h \
...
DOCS_ENUMS = \
  ...
  $(PROJECT_DIR)/$(META_OUTPUT_ROOT_FOLDER)controllers/algo/auto_generated_triggertypes.cpp \
  $(PROJECT_DIR)/$(META_OUTPUT_ROOT_FOLDER)controllers/algo/auto_generated_triggertypes.h \
