...
$(SIMULATOR_OUT): $(CONFIG_FILES)
	BOARD_DIR=../firmware/$(BOARD_DIR) $(MAKE) -C ../simulator -r SIMULATOR_DEBUG_LEVEL_OPT="-O2" OS="Windows_NT" SUBMAKE=yes

../simulator/build/rusefi_simulator: $(CONFIG_FILES)
	BOARD_DIR=../firmware/$(BOARD_DIR) $(MAKE) -C ../simulator -r SIMULATOR_DEBUG_LEVEL_OPT="-O2" OS="Linux" SUBMAKE=yes
...
.bootloader-sentinel: $(CONFIG_FILES)
	BOARD_DIR=../$(BOARD_DIR) TGT_SENTINEL=../$(TGT_SENTINEL) $(MAKE) -C bootloader -r SUBMAKE=yes
	@touch $@
